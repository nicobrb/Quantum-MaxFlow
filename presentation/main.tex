...
\begin{frame}
  ...
  \begin{figure}
    \begin{tikzpicture}
      ...
      \addplot plot coordinates {(1, 20)};
      \addplot plot coordinates {(2, 18)};
      \addplot plot coordinates {(3, 10)};
      \addplot plot coordinates {(4, 5)};

      \legend{Libreria, Edmonds Karp, Capacity Scaling, Quantum}
